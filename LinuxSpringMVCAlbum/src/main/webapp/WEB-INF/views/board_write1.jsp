	...
	<form action="./write_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th>파일첨부</th>
					<td colspan="3"><input type="file" id="file" name="upload" value="" class="board_write_input" /></td>
				</tr>
				<tr>
					<th>이메일</th>
			...
			<div class="btn_area">
				...
				<div class="align_right">			
					<input type="button" value="등록" id="wbtn" class="btn_write btn_txt01" style="cursor: pointer;" />					
				</div>	
			</div>	
			<!--//게시판-->
		</div>
